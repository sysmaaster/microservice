  ...
  about(req: Request, res: Response) {
    try {
      res.render("help", {
        title: "EMILL v6",
        text:
          " EMILL v6 Цей сервіс DEV-6 (API) створено 27.08.2023" +
  ...
  test(req: Request, res: Response, next: NextFunction) {
    try {
      res
        ...
        .send(
          " EMILL v6 Цей сервіс DEV-6 (API) створено 27.08.2023 в розробці до 30.10.2023 <br> продовжено 01.01.2024 Сервіс Категорій Допрацьвано 14.04.2024"
        );
    } catch (e) {
