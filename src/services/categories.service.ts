...
class CategoriesService {
    ...
    async create(newCatg:CategoriesCreateModel):Promise<CategoriesResponseModel | {} | false>{
        let result;
    ...
    async update(updCatg:CategoriesEditRequestModel):Promise<CategoriesResponseModel | {} | false>{
        let result
